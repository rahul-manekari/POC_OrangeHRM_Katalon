...
WebUI.setText(findTestObject('Object Repository/OrangeHRM_Employee_Create/input_Employee_firstName'), 'Abdul')

WebUI.setText(findTestObject('Object Repository/OrangeHRM_Employee_Create/input_Employee_middleName'), 'Kazim')

WebUI.setText(findTestObject('Object Repository/OrangeHRM_Employee_Create/input_Employee_lastName'), 'Nazir')

WebUI.setText(findTestObject('Object Repository/OrangeHRM_Employee_Create/input_Enter_Employee Id'), '001')

WebUI.click(findTestObject('Object Repository/OrangeHRM_Employee_Create/button_Employee_Save'))

WebUI.waitForAlert(2)

WebUI.setText(findTestObject('Object Repository/OrangeHRM_Employee_Create/input_Enter_Employee_Other Id'), 'AKN202010')

WebUI.setText(findTestObject('Object Repository/OrangeHRM_Employee_Create/input_Enter_driver_license_number'), 'MH1020121022')

WebUI.setText(findTestObject('Object Repository/OrangeHRM_Employee_Create/input_Enter_License Expiry Date'), '2026-10-10')

WebUI.setText(findTestObject('Object Repository/OrangeHRM_Employee_Create/input_Enter_SSN Number'), 'MH1010101090')

WebUI.setText(findTestObject('Object Repository/OrangeHRM_Employee_Create/input_Enter_SIN Number'), 'MH9090909010')
